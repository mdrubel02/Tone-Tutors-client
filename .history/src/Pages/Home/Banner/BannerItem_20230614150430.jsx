        ...
        <div className="relative w-full">
            ...
            <div className="relative bg-gray-900 bg-opacity-50 min-h-[90vh] font-jost items-center flex px-4 sm:px-10 lg:px-20 ">
                ...
                <div className="">
                    ...
                    <h2 className="block h-43 px-18 py-3 bg-[#FFA1AC] rounded-10 font-bold text-3xl font-jost font-bold text-white">
                    In kids we trust
                    </h2>
                    <h2 className='mb-6 font-jost text-3xl font-semibold tracking-tight sm:text-5xl bg-primary-secondary'> KIDS CENTER</h2>
